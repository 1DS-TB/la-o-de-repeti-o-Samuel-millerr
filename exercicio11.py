...
while escolha_menu_principal == 1:
    ...
    while vida_usuario > 0 or vida_inimigo > 0:
        ...
        if escolha_inimigo == "atacar":
        ...
        elif escolha_inimigo == "usar_itens":
            ...
            if item not in item_usado_inimigo:
                ...
                elif item == "2": vida_inimigo += 100; vida_inimigo = min(vida_inimigo, vida); item_usado_inimigo.append(item); print("O inimigo escolheu a poção de cura. O inimigo é curado em 100 pontos de HP!")
